...
*</span></td>
					    ...
					    <td width="39%"><span class="red">
					      <input name='txt3422222' type="text" class="text" style="width:60px" value=""/>
				        * 月份:<input name='txt3422222' type="text" class="text" style="width:60px" value=""/>				    </span></td>
					    </tr>
					  <tr>
					  ...
					  <tr>
					    ...
					    <td bgcolor="#CCCCCC"><span class="red">
<select name="select" id="gztype">
  <option selected="selected">==请选择==</option>
  <option value="加班">加班</option>
  <option value="请假">请假</option>
</select> 
*</span></td>
					    <td bgcolor="#CCCCCC"><input type="button" value="添加" onclick="T('tm');"/></td>
					  ...
					  <tr>
					    ...
					    <td colspan="4"><textarea name="textarea2" cols="120" rows="20"></textarea></td>
					  </tr>
					  </table>
			  <br />
				</fieldset>			</TD>
